-- Execute this SQL in your Supabase SQL Editor to create the DTI_CLARIFICATIONS table

-- Step 1: Create the table
-- Copy and run the content from: database/create_dti_clarifications.sql
